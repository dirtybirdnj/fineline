...
import sty from "./PlasmicSelect__OptionGroup.module.css"; // plasmic-import: rYC1Rf1vRK3RsO/css
import SUPER__PlasmicSelect from "./PlasmicSelect"; // plasmic-import: OWvt5HQc2rGxSE/render
      ...
      >
        {p.renderPlasmicSlot({
          defaultContents: (
            <React.Fragment>
              <Select__Option
                className={classNames("__wab_instance", sty.option__w0M2C)}
              />

              <Select__Option
                className={classNames("__wab_instance", sty.option__zLZU)}
              />
            </React.Fragment>
          ),
